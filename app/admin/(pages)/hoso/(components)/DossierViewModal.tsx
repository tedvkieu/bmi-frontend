      ...
      <div className="relative bg-white w-full w-full mx-12 max-h-[90vh] rounded-lg shadow-xl overflow-hidden flex flex-col">
        <div className="flex justify-between items-center p-4 border-b border-gray-200">
          <h2 className="text-xl font-bold text-[#1e3a8a]">
            Số đăng ký {document.registrationNo || ""}
          </h2>
              ...
              <table className="w-full border-collapse">
                <tbody>
                  ...
                  <tr className="border border-gray-300">
                    ...
                    >
                      Máy móc, thiết bị đã qua sử dụng nhập khẩu quy định tại
                      Điều 6, Quyết định số 18/2019/QĐ-TTg ngày 19 tháng 4 năm
                  ...
                  <tr className="border border-gray-300">
                    ...
                    >
                      ...
                      Doanh nghiệp; máy móc, thiết bị đáp ứng yêu cầu về an
                      toàn, tiết kiệm năng lượng, bảo vệ môi trường; chịu trách
                      nhiệm trước pháp luật về cam kết này và tính chính xác của
                      các thông tin cung cấp. Cam kết thực hiện đúng theo các
                      quy định pháp luật liên quan đến việc nhập khẩu hàng hóa
                      của Khách hàng.
                    </td>
                  </tr>
                  <tr className="border border-gray-300">
                  ...
                  <tr className="border border-gray-300">
                    ...
                    <td className={tableDataClass}>
                      <span
                        className={classNames(
                          inputClass,
                          "text-blue-700 underline text-sm"
                        )}
                      >
